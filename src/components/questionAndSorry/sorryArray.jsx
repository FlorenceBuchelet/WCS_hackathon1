const sorryArray = [
  ...
  {
    id: 2,
    excuse: "Dire que vous vous êtes trompés de date.",
    explication:
  ...
  },
  {
    id: 3,
    excuse:
    "Dire que vous allez chez la belle famille, et dire à la belle famille que vous allez dans votre famille.",
